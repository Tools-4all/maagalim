import {profilePreview} from './profile-view.js?v=v2';
import {PLAY_SPEED,reactionSpeed,nudgeAim,aimFeedback} from './precision.js?v=v2';
import {GROUPS,normalizeProfile,readProfile,writeProfile,hasProfile,quickChoices,chooseQuick} from './loadout.js?v=v2';
import {installViewport} from './viewport.js?v=v2';
import {Game,clamp,chargeProfile} from './physics.js?v=v2';
import {loadHuman} from './avatar.js?v=v2';
import {World} from './scene.js?v=v2';
import {BeachAudio,BEACH_TRACKS} from './audio.js?v=v2';
import {EXERCISES,LEVELS,TAUNTS,AI_MISSES} from './data.js?v=v2';
import {gestureIntent,HOLD_DELAY,SWIPE_DISTANCE,PRACTICE} from './controls.js?v=v2';
import {LESSONS,LESSON_ORDER,lessonFor,needsLandscape} from './guide.js?v=v2';
import {attachJoystick,movementInCamera} from './joystick.js?v=v2';
import {updateRoam} from './roam.js?v=v2';
